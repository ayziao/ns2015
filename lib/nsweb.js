...
var formHtml = (function () {/*
		<form action="./" method="POST" enctype="multipart/form-data">
			<div class="textarea">
				<textarea id="box" name="body" onKeyup="mojilenbody(value);"></textarea>
			</div>
			tag<input class="text" type="text" name="tags" onKeyup="mojilentag(value);">
			<input id="btn" class="submitbutton" type="submit" name="submit" value="post">
			...
			<script type="text/javascript">
				...
				function mojilenbody(str) {
					bodylen = str.trim().length;
					showmojilen();
				}

				function mojilentag(str) {
					taglen = str.trim().length;
					showmojilen();
				}
			</script>
